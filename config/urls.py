...
from apps.core.views import (
    ...
    LoginPreviewView,
    ProcessamentoLogView,
    ProcessamentoReexecutarView,
    ProcessamentoVerificarSaidaView,
    RotinaAutomaticaAgentesView,
    SalvarConfiguracaoGeralView,
    SalvarRotinaAutomaticaConfigView,
    ZerarUsoBielView,
    ...
    DocumentosProcessadosView,
    PortalLoginView,
    PortalLogoutView,
    PortalPainelView,
    ProcessamentoStatusView,
    ProcessamentoSaidaDownloadView,
    ProcessamentoDocumentoDownloadView,
    ProcessamentosAtivosView,
    ProcessamentosView,
...
urlpatterns = [
    ...
    path('documentos-processados/', DocumentosProcessadosView.as_view(), name='portal_documentos_processados'),
    path('processamentos/ativos/', ProcessamentosAtivosView.as_view(), name='portal_processamentos_ativos'),
    ...
    path('processamentos/<str:codigo>/saidas/<int:saida_id>/download/', ProcessamentoDocumentoDownloadView.as_view(), name='portal_processamento_download_documento'),
    ...
    path('processamentos/<str:codigo>/log/', ProcessamentoLogView.as_view(), name='portal_processamento_log'),
    path('processamentos/<str:codigo>/executar/', ProcessamentoReexecutarView.as_view(), name='portal_processamento_executar'),
    ...
    path('configuracoes-gerais/biel-zerar-uso/', ZerarUsoBielView.as_view(), name='portal_configuracao_geral_biel_zerar_uso'),
    ...
    path('rotina-automatica/', RotinaAutomaticaAgentesView.as_view(), name='portal_rotina_automatica'),
    path('rotina-automatica/salvar/', SalvarRotinaAutomaticaConfigView.as_view(), name='portal_rotina_automatica_salvar'),
